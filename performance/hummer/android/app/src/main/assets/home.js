...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var btn1 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    btn1.style = btnStyle;
    btn1.text = "列表基准测试（Scroller）";
    btn1.addEventListener('tap', function (event) {
      var pageInfo = {
        url: './scroller.js'
      };
      _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Navigator.openPage(pageInfo);
    });
    var btn2 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    btn2.style = btnStyle;
    btn2.text = "列表基准测试（List）";
    btn2.addEventListener('tap', function (event) {
      var pageInfo = {
        url: './list.js'
      };
      _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Navigator.openPage(pageInfo);
    });
    var btn3 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    btn3.style = btnStyle;
    btn3.text = "动画基准测试";
    ...
    var btn4 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    btn4.style = btnStyle;
    btn4.text = "拖拽基准测试";
    btn4.addEventListener('tap', function (event) {
      var pageInfo = {
        url: './drag.js'
      };
      _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Navigator.openPage(pageInfo);
    ...
    _this.appendChild(btn1);

    _this.appendChild(btn2);

    _this.appendChild(btn3);

    _this.appendChild(btn4);

    var btn11 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    ...
    var btn12 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    ...
    var btn13 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    ...
    var btn14 = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Button();
    ...
    _this.appendChild(btn11);

    _this.appendChild(btn12);

    _this.appendChild(btn13);

    _this.appendChild(btn14);
