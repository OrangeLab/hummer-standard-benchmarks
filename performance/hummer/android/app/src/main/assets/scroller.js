...
var RootView = /*#__PURE__*/function (_View) {
  ...
  function RootView() {
    ...
    var scroller = new _hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Scroller();
    scroller.style = {
      width: '100%',
      height: '100%'
    };
...
var ItemLayout = /*#__PURE__*/function (_View2) {
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_1__.default)(ItemLayout, _View2);

  var _super2 = (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_2__.default)(ItemLayout);

  function ItemLayout(index) {
    var _this2;

    (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__.default)(this, ItemLayout);
    ...
    _this2.style = {
      ...
      height: 48,
      margin: 4,
      backgroundColor: _common_CommonColor__WEBPACK_IMPORTED_MODULE_4__.Color.hm_green + '22',
      alignItems: 'center'
    };
    var item1 = new ItemCell(index);
    var item2 = new ItemCell(index);
    var item3 = new ItemCell(index);
    var item4 = new ItemCell(index);
    var item5 = new ItemCell(index);
    item1.addAnimation(new _common_CommonAnim__WEBPACK_IMPORTED_MODULE_5__.PositionAnim(), 'item1');
    item2.addAnimation(new _common_CommonAnim__WEBPACK_IMPORTED_MODULE_5__.RotationZAnim(), 'item2');
    item3.addAnimation(new _common_CommonAnim__WEBPACK_IMPORTED_MODULE_5__.ScaleAnim(), 'item3');
    item4.addAnimation(new _common_CommonAnim__WEBPACK_IMPORTED_MODULE_5__.OpacityAnim(), 'item4');
    item5.addAnimation(new _common_CommonAnim__WEBPACK_IMPORTED_MODULE_5__.BackgroundColorAnim(), 'item5');

    _this2.appendChild(item1);

    _this2.appendChild(item2);

    _this2.appendChild(item3);

    _this2.appendChild(item4);

    _this2.appendChild(item5);
...
var ItemCell = /*#__PURE__*/function (_Text) {
  (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_1__.default)(ItemCell, _Text);

  var _super3 = (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_2__.default)(ItemCell);

  function ItemCell(index) {
    var _this3;

    (0,_usr_local_lib_node_modules_hummer_cli_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__.default)(this, ItemCell);
  ...
  return ItemCell;
}(_hummer_hummer_front__WEBPACK_IMPORTED_MODULE_3__.Text);
